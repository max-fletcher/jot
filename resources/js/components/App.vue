    ...
    <div class="flex">
      ...
      <div class="bg-gray-200 w-48 h-screen border-r-2 border-gray-400">
        <nav>          
          ...
          <router-link to="/">
            <svg class="fill-current text-blue-600 w-12 h-12 ml-3 mt-2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
          ...
          <p class="pt-12 text-xs uppercase font-bold text-gray-500 pl-3"> create </p>
          <router-link to="/contacts/create" class="flex items-center py-2 hover:bg-blue-300 rounded mx-1 pl-2 text-sm">
            ...
            <div class="tracking-wide pl-3 font-bold"> Add New </div>
          </router-link>
          
          <p class="pt-12 text-xs uppercase font-bold text-gray-500 pl-3"> General </p>
          <router-link to="/contacts" class="flex items-center py-2 hover:bg-blue-300 rounded mx-1 pl-2 text-sm">
            ...
            <div class="tracking-wide pl-3 font-bold"> Contacts </div>
          </router-link>
          <router-link to="/birthdays" class="flex items-center py-2 hover:bg-blue-300 rounded mx-1 pl-2 text-sm">
            ...
            <div class="tracking-wide pl-3 font-bold"> Birthdays </div>
          </router-link>

          <p class="pt-12 text-xs uppercase font-bold text-gray-500 pl-3"> Settings </p>
          <router-link to="/logout" class="flex items-center py-2 hover:bg-blue-300 rounded mx-1 pl-2 text-sm">
            ...
            <div class="tracking-wide pl-3 font-bold"> Logout </div>
          </router-link>
...
<script>
  ...
  export default {
    name: "App",
    // the 'user' prop is being provided by Laravel's home page(home.blade.php). It is binded using prop.
    // We are gonna extract the api_token for a logged in user so that they can pass api requests to the backend
    props: [
      'user'
    ],
